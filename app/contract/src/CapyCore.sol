...
contract CapyCore is ReentrancyGuard, Ownable {
    ...
    /// @notice Address of the test token used for staking
    ...
    /// @notice Test token fee required for creating a poll
    ...
    /// @param _usdeToken Address of the test token
    ...
    function createPoll(
        ...
        // Transfer test tokens from creator
    ...
    /// @notice Updates the test token address
    /// @param _usdeToken New test token address
    ...
    /// @param newFee New fee in test tokens
